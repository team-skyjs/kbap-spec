...
**① OTA 재확인 3건** — 안드 공기계, 앱 **강제중지→2회 실행** 후:
- [ ] 언어 선택 화면: padding 회색 없음 (P-024 → KB-197 완료 게이트)
- [ ] 온보딩 기피 재료: 첫 선택 시 목록 안 밀림 (P-026 → KB-178 완료 게이트)
- [ ] 음식탭 기내모드: 헤더 없이 전체화면 오프라인 (P-027 → KB-174 게이트, P-028 검색화면은 별도)
