...
> **현재 상태(7/20)**: 설치·게스트 렌더·구글 로그인·온보딩 진입·언어 지역화 ✅ / UI 2건(KB-197·P-021) **preview OTA 발행 완료 → 예진 재확인 대기**(강제중지→2회 실행 후 온보딩 마지막 스텝 제출 버튼·언어 선택 화면) / 스캔 가로 감지(KB-198·P-022)는 **재빌드 필요 — 안드 빌드2 후 확인**. 아래 0·3번 진단은 **해결 완료**(기록 보존).
