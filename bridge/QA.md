...
> **현재 상태(7/20)**: 설치·게스트 렌더·구글 로그인·온보딩 진입·언어 지역화 ✅ / KB-197(P-021) 실기 확인 결과 **온보딩 제출 버튼 짤림 ✅ 해결 / 언어 선택 회색 padding ❌ 잔존** → 원인 재진단(Android elevation `sh1`+`overflow:hidden`, 리플 아님) → **KB-197 재수정 P-024 등록**(row에서 sh1 제거, OTA). / 스캔 가로(KB-198·P-022)는 **재빌드 필요 — 안드 빌드2 후 확인**. 아래 0·3번 진단은 **해결 완료**(기록 보존).
...
## Q-11 ❗️ 기피 재료 선택 UI B안 (→ KB-178 완료 게이트)
