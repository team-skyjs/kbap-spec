...
**① OTA 재확인 — 🎉 프로덕션 묶음 발행됨(7/21, 019f82cb): 아래 전부 이제 아이폰 테플로 가능!** 앱 **완전 종료→2회 실행** 후:
- [ ] 온보딩 기피 재료: 첫 선택 시 목록 안 밀림 (P-026 → KB-178 게이트)
- [ ] 음식탭 기내모드: 헤더 없이 전체화면 오프라인 (P-027 → KB-174 게이트)
- [ ] 검색화면 기내모드: 최근·지금인기 대신 전체화면 오프라인 (P-028 → KB-174 게이트)
- [ ] 프로필>수정 최하단: 가입 수단대로 표시 — 애플 계정이면 "Apple로 로그인" (P-029/Q-16)
- [ ] 안전 음식 상세: "이 메뉴 주문하기" → 사장님 카드 (P-030/Q-17)
- [ ] UI 폴리시 스팟 체크 — Q-18 (P-031·032. 스캔 화면 효과 2종은 차기 빌드라 제외)
- [ ] (안드 전용 — 에뮬레이터 준비 중) 언어 선택 회색 없음 (P-024 → KB-197 게이트)
