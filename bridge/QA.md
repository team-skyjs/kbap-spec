...
- **[커맨드 센터 7/20 — 계약 변경]** 스웨거 재배포에서 spicinessPreference가 **required 승격** → 스킵=생략 가정이 계약상 무효. **KB-195/P-019 등록** (스킵 시 -1 명시 전송). P-019 OTA 후엔 4번의 "가정" 단서가 사라지고 순수 확인 항목이 됨 — 그 전까지 4번에서 온보딩 스킵 가입이 400으로 실패하면 이 건이 원인.
