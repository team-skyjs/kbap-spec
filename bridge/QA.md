...
**✅ 7/22 확인 완료(티켓 종결)**: 가로 감지(KB-198)·크롭(KB-202)·스캔 효과·스캔 배너(KB-212)·랭킹 정렬/리뷰 정리·press/노드·헤더 바운싱(KB-217)·촬영(KB-218) — kinetics(KB-207)도 종결. **후속 예약**: 스캔 배너 UI 다듬기(예진 캡쳐 대기)·랭킹 자잘 UI(예진 상세 대기) → 오면 발주.
